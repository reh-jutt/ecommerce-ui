const Hero = () => {
  return (
    <div className="flex gap-4">
      <div className="flex-1 bg-gradient-to-r from-green-100 to-white p-6 rounded-lg shadow">
        ...
        <button className="bg-white text-black px-4 py-2 rounded shadow hover:bg-gray-100">Learn more</button>
      </div>
